      ...
      <section className="py-8 md:py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative px-10 sm:px-12">
            <Carousel opts={{ align: "center", loop: anuncios.length > 2 }} className="w-full">
              ...
              <CarouselPrevious className="h-9 w-9 bg-primary/80 hover:bg-primary text-primary-foreground border-none -left-10 sm:-left-12 transition-all duration-200" />
              <CarouselNext className="h-9 w-9 bg-primary/80 hover:bg-primary text-primary-foreground border-none -right-10 sm:-right-12 transition-all duration-200" />
            </Carousel>
          </div>
        </div>
      </section>
