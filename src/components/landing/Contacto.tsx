...
const Contacto = () => {
  ...
  return (
    <section id="contacto" className="py-20 px-4 bg-secondary/30">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-10">
          <p className="text-primary text-sm font-semibold mb-1">Contacto</p>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
            <div className="bg-card border border-border rounded-xl p-5">
              <h3 className="font-bebas text-lg text-foreground mb-1">📱 WHATSAPP</h3>
              <p className="text-muted-foreground">+57 300 000 0000</p>
            </div>
            <div className="bg-card border border-border rounded-xl p-5">
              <h3 className="font-bebas text-lg text-foreground mb-1">📘 FACEBOOK</h3>
              <p className="text-muted-foreground">@semillerodecampeonesav</p>
            </div>
            <div className="bg-card border border-border rounded-xl p-5">
              <h3 className="font-bebas text-lg text-foreground mb-1">📍 COBERTURA</h3>
